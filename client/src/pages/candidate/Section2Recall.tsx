...
export const Section2Recall: React.FC = () => {
  ...
  return (
    <div className="bg-surface-canvas font-body-default text-body-default text-text-primary antialiased min-h-screen flex flex-col justify-between">
        ...
        <div className="w-full max-w-[680px] flex flex-col gap-unit-8">
          ...
          <div className="flex flex-col gap-unit-2">
            <textarea
              ...
              autoFocus
              className="w-full bg-surface-card border border-border-rule rounded-[4px] p-unit-4 font-body-reading text-body-reading text-text-primary focus:border-primary-container focus:outline-none transition-colors"
            />
            <div className="flex justify-between items-center text-label-default text-text-muted">
          ...
          <div className="flex justify-end">
            <button
              type="button"
              onClick={handleNext}
              className="bg-primary-container text-white px-unit-6 py-2 rounded-[4px] font-semibold hover:bg-[#172554] transition-colors cursor-pointer"
            >
      ...
      <footer className="w-full bg-surface-canvas py-unit-8 border-t border-border-rule">
